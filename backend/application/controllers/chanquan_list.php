...
class Chanquan_list extends CI_Controller
{
	...
	public function show($page = 1)
	{
		...
		$config['base_url'] = site_url('chanquan_list/show');
	...
	public function delete($sliderId = 0)
	{
		...
		showMessage(MESSAGE_TYPE_SUCCESS, 'ARTICLE_DELETE_SUCCESS', '', 'chanquan_list/show', true, 5);
	}
	...
	public function submit()
	{
		...
		if(empty($name))
		{
			showMessage(MESSAGE_TYPE_ERROR, 'NO_PARAM', '', 'chanquan_list/show', true, 5);
		}
		...
		showMessage(MESSAGE_TYPE_SUCCESS, 'ARTICLE_SUBMIT_SUCCESS', '', 'chanquan_list/show', true, 5);
	}
}
