...
class Caigou_list extends CI_Controller
{
	...
	public function show($page = 1)
	{
		...
		$config['base_url'] = site_url('caigou_list/show');
	...
	public function delete($sliderId = 0)
	{
		...
		showMessage(MESSAGE_TYPE_SUCCESS, 'ARTICLE_DELETE_SUCCESS', '', 'caigou_list/show', true, 5);
	}
	...
	public function submit()
	{
		...
		showMessage(MESSAGE_TYPE_SUCCESS, 'ARTICLE_SUBMIT_SUCCESS', '', 'caigou_list/show', true, 5);
	}
}
