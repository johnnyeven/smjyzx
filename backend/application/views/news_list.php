				...
				<div class="widget">
					...
					<div class="widget-content">
						...
						<form id="edit-profile" class="form-horizontal" action="<?php echo site_url('news_list/submit'); ?>" method="post" />
                                    <fieldset>
                            ...
                            <?php if(!empty($result)): ?>
								...
								<tr>
									...
									<td class="action-td">
										...
										<a href="<?php echo site_url('news_list/delete/' . $row->id); ?>" class="btn btn-small">
