						...
						<table class="table table-striped table-bordered" id="imgTable">
                            ...
                            <?php if(!empty($result)): ?>
								...
								<tr>
									...
									<td class="action-td">
										<a href="<?php echo site_url('chanquan_list/edit/' . $row->id); ?>" class="btn btn-small btn-warning">
											<i class="icon-edit"></i>								
										</a>					
										<a href="<?php echo site_url('chanquan_list/delete/' . $row->id); ?>" class="btn btn-small">
				...
				<div class="widget">
					...
					<div class="widget-content">
						...
						<form id="edit-profile" class="form-horizontal" action="<?php echo site_url('chanquan_list/submit'); ?>" method="post" />
                                    <fieldset>
