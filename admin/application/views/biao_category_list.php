						...
						<table class="table table-striped table-bordered" id="imgTable">
                            ...
                            <?php if(!empty($result)): ?>
								...
								<tr>
									...
									<td class="action-td">
										<a href="<?php echo site_url('biao_category_list/edit/' . $row->id); ?>" class="btn btn-small btn-warning">
											<i class="icon-edit"></i>								
										</a>					
										<a href="<?php echo site_url('biao_category_list/delete/' . $row->id); ?>" class="btn btn-small">
				...
				<div class="widget">
					...
					<div class="widget-header">
						<i class="icon-th-list"></i>
						<h3><?php if(empty($edit)): ?>添加<?php else: ?>修改<?php endif; ?>分类</h3>
					</div> <!-- /widget-header -->
					
					<div class="widget-content">
					
						<form id="edit-profile" class="form-horizontal" action="<?php echo site_url('biao_category_list/submit'); ?>" method="post" />
                                    <fieldset>
