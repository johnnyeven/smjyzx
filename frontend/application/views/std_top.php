<div class="top">
          <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="980" height="250">
              <param name="movie" value="<?php echo base_url('resources/images/banner.swf'); ?>" />
              ...
              <!--[if !IE]>-->
              <object type="application/x-shockwave-flash" data="<?php echo base_url('resources/images/banner.swf'); ?>" width="980" height="250">
                <!--<![endif]-->
                <param name="quality" value="high" />
                <param name="wmode" value="opaque" />
                <param name="swfversion" value="15.0.0.0" />
